...
### Fit the model
history = meta_model.fit([U_k,Interval], In, epochs=epoch,verbose=2, shuffle=True, batch_size=batch_size,validation_data=([U_k,Interval], In))
...
# \Python3\python.exe autoencoder_array_interval.py BAC 8 4 500 BER 10000